export default defineNuxtRouteMiddleware((to, from) => {
  // --- MOCK MODE: ปิดการทำงานของระบบเช็คสิทธิ์ (Auth Guard) เพื่อทดสอบหน้าบ้าน ---
  // การ return ทันทีจะทำให้เข้าได้ทุกหน้าโดยไม่ถูก redirect
  // หากต้องการกลับไปใช้ระบบหลังบ้านจริง ให้เอาคอมเมนต์ (/* ... */) ด้านล่างออก และลบบรรทัด return นี้ทิ้ง
  return;
