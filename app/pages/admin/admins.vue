        ...
        <div class="bg-white dark:bg-slate-800 w-full max-w-lg rounded-[32px] shadow-2xl overflow-hidden animate-[fadeIn_0.3s_ease-out] border border-white/20">
          ...
          <form @submit.prevent="handleSubmit" class="p-8 space-y-6">
            <div class="space-y-1.5">
              ...
              <input v-model="form.fullname" type="text" required class="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all text-sm font-bold bg-slate-50/50" placeholder="กรอกชื่อ-นามสกุล">
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-1.5">
                <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">Username</label>
                <input v-model="form.username" type="text" required class="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all text-sm font-bold bg-slate-50/50" placeholder="กรอกชื่อผู้ใช้">
              </div>
              <div class="space-y-1.5">
                <label class="text-xs font-black text-slate-400 uppercase tracking-widest px-1">บทบาท</label>
                <div class="relative">
                  <select v-model="form.role" class="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all text-sm font-bold bg-slate-50/50 appearance-none">
            ...
            <div class="space-y-1.5">
              ...
              <input v-model="form.email" type="email" required class="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all text-sm font-bold bg-slate-50/50" placeholder="admin@example.com">
            </div>
